...
function DiscordLib:Window(text)
	...
	UserPanelUserIcon.MouseButton1Click:Connect(function()
		...
		ChangeBtn.BackgroundColor3 = Color3.fromRGB(146, 57, 120)
		...
		ChangeBtn.MouseLeave:Connect(function()
			TweenService:Create(
				ChangeBtn,
				TweenInfo.new(.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
				{BackgroundColor3 = Color3.fromRGB(146, 57, 120)}
			):Play()
		end)
		...
		CloseBtn1.BackgroundColor3 = Color3.fromRGB(146, 57, 120)
		...
		ResetBtn.BackgroundColor3 = Color3.fromRGB(146, 57, 120)
	...
	function DiscordLib:Notification(titletext, desctext, btntext)
		...
		AlrightBtn.BackgroundColor3 = Color3.fromRGB(146, 57, 120)
	...
	function ServerHold:Server(text, img)
		...
		function ChannelHold:Channel(text)
			...
			function ChannelContent:Button(text,callback)
				...
				Button.BackgroundColor3 = Color3.fromRGB(146, 57, 120)
				...
				Toggle.MouseButton1Click:Connect(function()
					if toggled == false then
						TweenService:Create(
							Icon,
							TweenInfo.new(.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
							{ImageColor3 = Color3.fromRGB(146, 57, 120)}
						):Play()
						TweenService:Create(
							ToggleFrame,
							TweenInfo.new(.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
			...
			function ChannelContent:Slider(text, min, max, start, callback)
				...
				CurrentValueFrame.BackgroundColor3 = Color3.fromRGB(146, 57, 120)
